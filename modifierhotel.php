...
<body>
    ...
    <label for="num">num du hotel :</label>
    <input type="text" name="num" id="nom" required>
        <label for="nom">nom du hotel :</label>
        <input type="text" name="nom" id="nom" required>
        <label for="type"> adresse:</label>
        <input type="text" name="ad" id="type" required>
        <label for="con">conatct:</label>
        <input type="int" name="cont" id="con" required>
        <label for="sta">description:</label>
        <input type="text" name="des" id="sta" required>
        <label for="li">lien</label>
